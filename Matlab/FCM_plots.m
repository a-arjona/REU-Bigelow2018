...
T = readtable('C:/Users/Ade/Documents/Bigelow/DINEOF-2018/txt_files/fuzzy_cl.txt');
...
for year = 1:20
    ...
    filename = strcat('C:/Users/Ade/Documents/Bigelow/DINEOF-2018/Interannual-Data/txt_files/', c_year, 'FCM.txt');
    ...
    title(gt)
    pic_name = strcat('C:/Users/Ade/Documents/Bigelow/DINEOF-2018/Interannual-Data/m_figure/',c_year,'FCMmap.png');
    saveas(gcf,pic_name)
end